...
// This example shows how to append new value with server timestamp to a map field usng commit. This operation required Email/password, custom or OAUth2.0 authentication.
